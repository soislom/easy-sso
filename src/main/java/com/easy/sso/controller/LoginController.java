...
public class LoginController {
	...
	public String userLogin(@ModelAttribute User user,
		...
		try {
			...
			((HttpServletResponse) response).setHeader(JwtUtils.AUTH_HEADER,
					jwtToken);
			if (redirect != null) {
	...
	@RequestMapping("/auth")
	@ResponseBody
	public Response<Object> auth(HttpServletRequest request,
	...
	private AuthenticationToken createToken(ServletRequest servletRequest,
			ServletResponse servletResponse) {
		HttpServletRequest httpServletRequest = (HttpServletRequest) servletRequest;
		String authorization = httpServletRequest
				.getHeader(JwtUtils.AUTH_HEADER);
	...
	public Response<Date> queryExpireDate(
